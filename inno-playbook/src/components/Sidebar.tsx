...
interface SidebarProps {
  ...
  orgName: string;
  orgSector: string;
  onSaveOrg: (name: string, sector: string) => void;
    ...
    <>
      <div className="sidebar">
        ...
        <div className="sidebar-bot">
          ...
          {orgId && (
            <button
              className={`sb-btn ${showActivityFeed ? 'active' : ''}`}
              onClick={onToggleActivityFeed}
            >
              <span>⚡</span>
              {showActivityFeed ? 'Hide Activity Feed' : 'Activity Feed'}
            </button>
          )}
        </div>
      </div>
      ...
      {showActivityFeed && orgId && (
        <div className="activity-feed-overlay">
          <ActivityFeed
            orgId={orgId}
            onClose={() => onToggleActivityFeed?.()}
          />
        </div>
      )}
    </>
